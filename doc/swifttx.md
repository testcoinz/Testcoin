...
This mechanism has been integrated into Bitcore-Node-TestCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TestCoin-Project/insight-api-testcoin#web-socket-api](https://github.com/TestCoin-Project/insight-api-testcoin#web-socket-api) 
* API: [https://github.com/TestCoin-Project/insight-api-testcoin#swifttx-transactions](https://github.com/TestCoin-Project/insight-api-testcoin#swifttx-transactions) 
...
By default, the TestCoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TestCoin daemon:
