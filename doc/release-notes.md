TestCoin version 2.3.1 is now available from:
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/testcoinz/Testcoin/issues>

Compatibility
==============

TestCoin is extensively tested on multiple operating systems using
...
TestCoin should also work on most other Unix-like systems but is not
...
Examples:
> testcoin-cli masternodestart "alias" "my_mn"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "masternodestart", "params": ["alias" "my_mn"] }' -H 'content-type: text/plain;' http://127.0.0.1:49697/
```
...
Examples:
> testcoin-cli mnvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "mnvote", "params": ["local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"] }' -H 'content-type: text/plain;' http://127.0.0.1:49697/
```
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) TestCoin address of payment
...
Examples:
> testcoin-cli getbudgetprojection
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getbudgetprojection", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:49697/
```
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/testcoin-project-translations/).
