...
git clone https://github.com/testcoin-crypto/testcoin.git
cd testcoin
...
To build TestCoin (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/testcoin-crypto/testcoin
...
For example:
```bash
URL=https://github.com/crowning-/testcoin.git
...
[testcoin/gitian.sigs](https://github.com/testcoin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
