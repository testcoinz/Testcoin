Contributing to TestCoin
============================

The TestCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the TestCoin project, and is not to be
confused with overall TestCoin Network Protocol consensus changes.

Whether a pull request is merged into TestCoin rests with the project merge
...
The project leader is the release manager for each TestCoin release.
