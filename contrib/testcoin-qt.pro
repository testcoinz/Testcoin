...
RESOURCES += src/qt/testcoin.qrc src/qt/testcoin_locale.qrc

TRANSLATIONS += src/qt/locale/testcoin_bg.ts \
                src/qt/locale/testcoin_de.ts \
                src/qt/locale/testcoin_en.ts \
                src/qt/locale/testcoin_es.ts \
                src/qt/locale/testcoin_fi.ts \
                src/qt/locale/testcoin_fr.ts \
                src/qt/locale/testcoin_it.ts \
                src/qt/locale/testcoin_ja.ts \
                src/qt/locale/testcoin_pl.ts \
                src/qt/locale/testcoin_pt.ts \
                src/qt/locale/testcoin_ru.ts \
                src/qt/locale/testcoin_sk.ts \
                src/qt/locale/testcoin_sv.ts \
                src/qt/locale/testcoin_vi.ts \
                src/qt/locale/testcoin_zh_CN.ts \
                src/qt/locale/testcoin_zh_TW.ts
