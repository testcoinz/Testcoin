                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TestCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TestCoin"), this);
    aboutAction->setStatusTip(tr("Show information about TestCoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the TestCoin help message to get a list with possible TestCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TestCoin client") + " " + networkStyle->getTitleAddText();
