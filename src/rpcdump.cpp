...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"testcoinaddress\"\n"
            "\nEncrypts a private key corresponding to 'testcoinaddress'.\n"
            "\nArguments:\n"
            "1. \"testcoinaddress\"   (string, required) The testcoin address for the private key (you must hold the key already)\n"
