...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Testcoin features */
        {"testcoin", "masternode", &masternode, true, true, false},
        {"testcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"testcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"testcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"testcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"testcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"testcoin", "startmasternode", &startmasternode, true, true, false},
        {"testcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"testcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"testcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"testcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"testcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"testcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"testcoin", "mnbudget", &mnbudget, true, true, false},
        {"testcoin", "preparebudget", &preparebudget, true, true, false},
        {"testcoin", "submitbudget", &submitbudget, true, true, false},
        {"testcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"testcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"testcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"testcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"testcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"testcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"testcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"testcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"testcoin", "mnsync", &mnsync, true, true, false},
        {"testcoin", "spork", &spork, true, true, false},
        {"testcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"testcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:49697/\n";
}
