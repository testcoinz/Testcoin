...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "testcoin" is a composite category enabling all TestCoin-related debug output
            if (ptrCategory->count(string("testcoin"))) {
    ...
    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty testcoin.conf if it does not exist
